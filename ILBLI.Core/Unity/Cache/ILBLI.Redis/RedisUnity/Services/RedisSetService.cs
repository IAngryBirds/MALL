...
namespace ILBLI.Redis 
{
    ...
    /// </summary>
    public class RedisSetService : RedisBaseService
    {
        #region 构造函数
        ...
        public RedisSetService(string connectionString, int defaultDB=0) :
        ...
        { 
            ...
            return _conn.GetDatabase(_DefaultDB).SetAdd(key, jValue);
        }
        /// <summary>
        /// 在Key集合中添加多个value值
        /// </summary>
        ...
        { 
            ...
            return _conn.GetDatabase(_DefaultDB).SetAdd(key, valueList);
        }
        ...
        { 
            return _conn.GetDatabase(_DefaultDB).SetLength(key);
        }
        ...
        { 
            string jValue = ConvertJson(value);
            return _conn.GetDatabase(_DefaultDB).SetContains(key, jValue);
        }
        ...
        { 
            var rValue = _conn.GetDatabase(_DefaultDB).SetRandomMember(key);
        ...
        { 
            var rValue = _conn.GetDatabase(_DefaultDB).SetMembers(key);
        ...
        { 
            ...
            return _conn.GetDatabase(_DefaultDB).SetRemove(key, valueList);
        }
        ...
        { 
            var rValue = _conn.GetDatabase(_DefaultDB).SetPop(key);
            return ConvertObj<T>(rValue);
        }
        ...
        { 
            string jValue = ConvertJson(value);
            return await _conn.GetDatabase(_DefaultDB).SetAddAsync(key, jValue);
        }
        /// <summary>
        /// 在Key集合中添加多个value值
        /// </summary>
        ...
        { 
            RedisValue[] valueList = base.ConvertRedisValue(value.ToArray());
            return await _conn.GetDatabase(_DefaultDB).SetAddAsync(key, valueList);
        }
        ...
        { 
            return await _conn.GetDatabase(_DefaultDB).SetLengthAsync(key);
        }
        ...
        { 
            string jValue = ConvertJson(value);
            return await _conn.GetDatabase(_DefaultDB).SetContainsAsync(key, jValue);
        }
        ...
        { 
            var rValue = await _conn.GetDatabase(_DefaultDB).SetRandomMemberAsync(key);
            return ConvertObj<T>(rValue);
        }
        ...
        { 
            var rValue = await _conn.GetDatabase(_DefaultDB).SetMembersAsync(key);
            return ConvetList<T>(rValue);
        }
        ...
        { 
            RedisValue[] valueList = base.ConvertRedisValue(value);
            return await _conn.GetDatabase(_DefaultDB).SetRemoveAsync(key, valueList);
        }
        ...
        { 
            var rValue = await _conn.GetDatabase(_DefaultDB).SetPopAsync(key);
            return ConvertObj<T>(rValue);
        }
        ...
        private List<T> _SetCombine<T>(SetOperation operation, params string[] keys)
        {
            ...
            var rValue = _conn.GetDatabase(_DefaultDB).SetCombine(operation, keyList);
            return ConvetList<T>(rValue);
        }
        ...
        { 
            RedisKey[] keyList = base.ConvertRedisKeys(keys);
            return _conn.GetDatabase(_DefaultDB).SetCombineAndStore(operation, destination, keyList);
        }
        /// <summary>
        /// 获取几个集合的交叉并集合
        /// </summary>
        ...
        { 
            RedisKey[] keyList = base.ConvertRedisKeys(keys);
            return await _conn.GetDatabase(_DefaultDB).SetCombineAndStoreAsync(operation, destination, keyList);
        }
